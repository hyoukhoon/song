...
$source=file_get_contents("https://api.upbit.com/v1/ticker?markets=KRW-XLM");
$ss=json_decode($source);
$XLM=$ss[0]->trade_price;
    ...
    <div class="container">
      ...
      <div class="row">
		<div >
			...
			비트코인 : <span id="bitval"><?echo number_format($BTC);?></span> 원 / 이더리움 : <span id="ethval"><?echo number_format($ETH);?></span> 원 / 라이트코인 : <span id="ltcval"><?echo number_format($LTC);?></span>원 / 리플 : <span id="xrpval"><?echo number_format($XRP);?></span>원
