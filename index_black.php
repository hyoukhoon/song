...
if($gubun=="review" or $gubun=="info"){
	...
	$que2="select count(1) from every_board where multi in ('free','sisa','humor','star','review','black') and site_reg_date > DATE_ADD(now(), INTERVAL -168 HOUR) and site_reg_date<='$today_date' $where";

}else{
		$que2="select count(1) from every_board where multi in ('free','sisa','humor','star','review','black') and site_reg_date > DATE_ADD(now(), INTERVAL -24 HOUR) and site_reg_date<='$today_date' $where";
}
...
if($gubun=="review" or $gubun=="info"){
	$que="SELECT * FROM every_board where multi in ('free','sisa','humor','star','review','black') and site_reg_date > DATE_ADD(now(), INTERVAL -168 HOUR) and site_reg_date<='$today_date'  $where $ord  limit $start_page, $end_page";
}else{
