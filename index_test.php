...
?>
			<tr style="line-height:30px;cursor:pointer;" >
			  ...
			  <td><?if($rs->site_name=="hnhn" or $rs->site_name=="dorosi" or $rs->site_name=="thezam" or $rs->site_name=="bbongbra"){?>[후방]<?}?><a href="javascript:move_page('<?=urlencode($url)?>','<?=$rs->num?>');"><?=$rs->subject?></a></td>
